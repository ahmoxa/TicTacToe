...
import java.awt.*;
    ...
    public GraphicField() {
        ...
        new GraphicCell(this, 1, 0);
        new GraphicCell(this, 2, 0);

        // add(new GraphicCell(this, 1, 1));
    ...
    private void paintGradientBoxForFieldBottom(Graphics2D g) {
        ...
        GradientPaint paint = new GradientPaint(lw, lh, Color.white, lw / 4, lh / 4, Color.GRAY, true);
        g.setPaint(paint);
