...
public class F_Menu{
    ...
    public   F_Menu() {
        ...
        c.gridx = 2;
        c.gridy = 0;
        menuPan.add(playerAIBut_1, c);
        c.gridx = 3;
        c.gridy = 0;
        menuPan.add(playerHumanBut_1, c);

        c.gridx = 2;
        c.gridy = 1;
        menuPan.add(playerAIBut_2, c);
        c.gridx = 3;
        c.gridy = 1;
        menuPan.add(playerHumanBut_2, c);

        startBut = new JButton("Ok");
...
//        c.gridwidth = 2;
        ...
        menuPan.add(startBut, c);

        frame.getContentPane().add(menuPan);
